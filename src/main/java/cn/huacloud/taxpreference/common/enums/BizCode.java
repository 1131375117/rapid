...
public enum BizCode {
    ...
    _4314(4314, "您保存的数据存在必填项未校验,请重新修改后提交"),
    _4315(4315, "留存备查资料、提交税务机关资料、报送时限至少填写其中一项"),
    _4316(4316, "文号不能全部为空"),
    _4317(4317, "当前政策法规未发布不能发布政策解读"),
    ...
    _4405(4405, "未开启爬虫数据同步调度"),
    _4406(4404, "邮寄验证发送过于频繁，请于{}秒后再进行发送"),
    ...
    _4702(4702, "未提供Token"),
    _4703(4703, "Token已过期"),
    _4704(4704, "系统重启,需重新获取token值"),
    _4705(4705, "服务繁忙,请稍后再试"),
    _47056(4706, "需要在请求头中提供OpenUserId参数"),
